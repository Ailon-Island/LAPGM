...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--max_iter', type=int, default=1000, help='number of iterations')
        self.parser.add_argument('--batch_size', type=int, default=32, help='batch size')
        self.parser.add_argument('--optimizer', type=str, default='adamw', help='optimizer')
        self.parser.add_argument('--lr', type=float, default=0.001, help='learning rate')
        self.parser.add_argument('--weight_decay', type=float, default=0., help='weight decay')
        self.parser.add_argument('--lr_scheduler', type=str, default='step', help='learning rate scheduler')

        # Testing
        self.parser.add_argument('--test_epoch', type=int, default=1, help='test every n epochs')
        self.parser.add_argument('--test_final_only', type=bool, default=False, help='test only at the end')
        ...
        self.parser.add_argument('--resume_iter', type=str, default='latest', help='resume iteration, \'0\' for latest')
    ...
    def parse(self, save=True):
        ...
        # set resume iter for latest
        if self.opt.resume_iter == '0':
